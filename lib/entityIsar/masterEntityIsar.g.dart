...
extension GetMasterCollection on Isar {
  IsarCollection<Master> get masters => getCollection();
}

const MasterSchema = CollectionSchema(
  name: 'Master',
  schema:
  ...
  getId: _masterGetId,
  setId: _masterSetId,
  getLinks: _masterGetLinks,
  attachLinks: _masterAttachLinks,
  serializeNative: _masterSerializeNative,
  deserializeNative: _masterDeserializeNative,
  deserializePropNative: _masterDeserializePropNative,
  serializeWeb: _masterSerializeWeb,
  deserializeWeb: _masterDeserializeWeb,
  deserializePropWeb: _masterDeserializePropWeb,
  version: 3,
);

int? _masterGetId(Master object) {
...
void _masterSetId(Master object, int id) {
  object.id = id;
}

List<IsarLinkBase> _masterGetLinks(Master object) {
  return [];
}

void _masterSerializeNative(
    IsarCollection<Master> collection,
...
Master _masterDeserializeNative(IsarCollection<Master> collection, int id,
...
P _masterDeserializePropNative<P>(
...
dynamic _masterSerializeWeb(IsarCollection<Master> collection, Master object) {
  ...
  IsarNative.jsObjectSet(
      jsObj, 'optionTime1', object.optionTime1?.toUtc().millisecondsSinceEpoch);
  IsarNative.jsObjectSet(
      jsObj, 'optionTime2', object.optionTime2?.toUtc().millisecondsSinceEpoch);
...
Master _masterDeserializeWeb(IsarCollection<Master> collection, dynamic jsObj) {
  final object = Master(
...
P _masterDeserializePropWeb<P>(Object jsObj, String propertyName) {
  switch (propertyName) {
    case 'code':
...
void _masterAttachLinks(IsarCollection col, int id, Master object) {}
...
extension MasterQueryWhere on QueryBuilder<Master, Master, QWhereClause> {
  ...
  QueryBuilder<Master, Master, QAfterWhereClause> idGreaterThan(int id,
      {bool include = false}) {
    return addWhereClauseInternal(
  ...
  QueryBuilder<Master, Master, QAfterWhereClause> idLessThan(int id,
      {bool include = false}) {
    return addWhereClauseInternal(
