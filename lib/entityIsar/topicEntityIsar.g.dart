...
extension GetTopicCollection on Isar {
  IsarCollection<Topic> get topics => getCollection();
}
...
const TopicSchema = CollectionSchema(
  ...
  attachLinks: _topicAttachLinks,
  serializeNative: _topicSerializeNative,
  deserializeNative: _topicDeserializeNative,
  deserializePropNative: _topicDeserializePropNative,
  serializeWeb: _topicSerializeWeb,
  deserializeWeb: _topicDeserializeWeb,
  deserializePropWeb: _topicDeserializePropWeb,
  version: 3,
);

int? _topicGetId(Topic object) {
...
void _topicSetId(Topic object, int id) {
  object.id = id;
}

List<IsarLinkBase> _topicGetLinks(Topic object) {
  return [];
}

void _topicSerializeNative(
    IsarCollection<Topic> collection,
...
Topic _topicDeserializeNative(IsarCollection<Topic> collection, int id,
...
P _topicDeserializePropNative<P>(
...
dynamic _topicSerializeWeb(IsarCollection<Topic> collection, Topic object) {
...
Topic _topicDeserializeWeb(IsarCollection<Topic> collection, dynamic jsObj) {
  final object = Topic(
    ...
    IsarNative.jsObjectGet(jsObj, 'photoUpdateCnt') ?? double.negativeInfinity,
...
P _topicDeserializePropWeb<P>(Object jsObj, String propertyName) {
  switch (propertyName) {
    case 'categoryDocId':
    ...
    case 'photoFile':
      return (IsarNative.jsObjectGet(jsObj, 'photoFile') ?? Uint8List(0)) as P;
...
void _topicAttachLinks(IsarCollection col, int id, Topic object) {}
...
extension TopicQueryWhere on QueryBuilder<Topic, Topic, QWhereClause> {
  ...
  QueryBuilder<Topic, Topic, QAfterWhereClause> idGreaterThan(int id,
      {bool include = false}) {
    return addWhereClauseInternal(
  ...
  QueryBuilder<Topic, Topic, QAfterWhereClause> idLessThan(int id,
      {bool include = false}) {
    return addWhereClauseInternal(
