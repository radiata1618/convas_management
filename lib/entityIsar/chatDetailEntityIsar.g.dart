...
extension GetChatDetailCollection on Isar {
  IsarCollection<ChatDetail> get chatDetails => getCollection();
}
...
const ChatDetailSchema = CollectionSchema(
  ...
  setId: _chatDetailSetId,
  getLinks: _chatDetailGetLinks,
  attachLinks: _chatDetailAttachLinks,
  serializeNative: _chatDetailSerializeNative,
  deserializeNative: _chatDetailDeserializeNative,
  deserializePropNative: _chatDetailDeserializePropNative,
  serializeWeb: _chatDetailSerializeWeb,
  deserializeWeb: _chatDetailDeserializeWeb,
  deserializePropWeb: _chatDetailDeserializePropWeb,
  version: 3,
);

int? _chatDetailGetId(ChatDetail object) {
...
void _chatDetailSetId(ChatDetail object, int id) {
  object.id = id;
}

List<IsarLinkBase> _chatDetailGetLinks(ChatDetail object) {
  return [];
}

void _chatDetailSerializeNative(
...
ChatDetail _chatDetailDeserializeNative(IsarCollection<ChatDetail> collection,
...
P _chatDetailDeserializePropNative<P>(
...
dynamic _chatDetailSerializeWeb(
    IsarCollection<ChatDetail> collection, ChatDetail object) {
  ...
  IsarNative.jsObjectSet(jsObj, 'receiverUserDocId', object.receiverUserDocId);
...
ChatDetail _chatDetailDeserializeWeb(
    IsarCollection<ChatDetail> collection, dynamic jsObj) {
  final object = ChatDetail(
...
P _chatDetailDeserializePropWeb<P>(Object jsObj, String propertyName) {
  switch (propertyName) {
...
void _chatDetailAttachLinks(IsarCollection col, int id, ChatDetail object) {}
...
extension ChatDetailQueryWhere
  ...
  QueryBuilder<ChatDetail, ChatDetail, QAfterWhereClause> idGreaterThan(int id,
      {bool include = false}) {
    return addWhereClauseInternal(
  ...
  QueryBuilder<ChatDetail, ChatDetail, QAfterWhereClause> idLessThan(int id,
      {bool include = false}) {
    return addWhereClauseInternal(
